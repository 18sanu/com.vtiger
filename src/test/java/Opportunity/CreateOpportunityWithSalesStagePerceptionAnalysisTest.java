 ...
 *
 */
public class CreateOpportunityWithSalesStagePerceptionAnalysisTest extends BaseClass {
    @Test
	public void createOpportunityWithSalesStagePerceptionAnalysisTest() throws IOException, InterruptedException {
    	 // generating random numbers
		int randomNum = jUtils.randomValue();
        
		//reading data from excel file
		String orgName = eUtils.getStringDataFromExcelSheet("Sheet1", 2, 2) + randomNum;
		String firstName = eUtils.getStringDataFromExcelSheet("Sheet1", 2, 3) + randomNum;
		String lastName = eUtils.getStringDataFromExcelSheet("Sheet1", 2, 4) + randomNum;
		String opportunityName = eUtils.getStringDataFromExcelSheet("Sheet1", 2, 5) + randomNum;
		String salesStage = eUtils.getStringDataFromExcelSheet("Sheet1", 2, 6);
