...
public class CreateOpportunitywithSalesStageClosedWonTest extends BaseClass {
	...
	@Test
	public void createOpportunitywithSalesStageClosedWonTest() throws EncryptedDocumentException, IOException, InterruptedException {
        
		 // generating random numbers
		int randomNum = jUtils.randomValue();
        
		//reading data from excel file
		String orgName = eUtils.getStringDataFromExcelSheet("Sheet1", 5, 2) + randomNum;
		String firstName = eUtils.getStringDataFromExcelSheet("Sheet1", 5, 3) + randomNum;
		String lastName = eUtils.getStringDataFromExcelSheet("Sheet1", 5, 4) + randomNum;
		String opportunityName = eUtils.getStringDataFromExcelSheet("Sheet1", 5, 5) + randomNum;
		String salesStage = eUtils.getStringDataFromExcelSheet("Sheet1", 5, 6);
