...
public class CreateOpportunitywithSalesStageIdDecisionMakersTest extends BaseClass {
     @Test
	public  void  createOpportunitywithSalesStageIdDecisionMakersTest() throws IOException, InterruptedException {
    	// generating random numbers
 		int randomNum = jUtils.randomValue();
         
 		//reading data from excel file
 		String orgName = eUtils.getStringDataFromExcelSheet("Sheet1",1, 2) + randomNum;
 		String firstName = eUtils.getStringDataFromExcelSheet("Sheet1", 1, 3) + randomNum;
 		String lastName = eUtils.getStringDataFromExcelSheet("Sheet1", 1, 4) + randomNum;
 		String opportunityName = eUtils.getStringDataFromExcelSheet("Sheet1", 1, 5) + randomNum;
 		String salesStage = eUtils.getStringDataFromExcelSheet("Sheet1", 1, 6);
