...
public class CreateOpportunitywithSalesStageProposalPriceQuoteTest extends BaseClass {
     
	@Test
	public void createOpportunitywithSalesStageProposalPriceQuoteTest() throws IOException, InterruptedException {
		// generating random numbers
				int randomNum = jUtils.randomValue();
		        
				//reading data from excel file
				String orgName = eUtils.getStringDataFromExcelSheet("Sheet1", 3, 2) + randomNum;
				String firstName = eUtils.getStringDataFromExcelSheet("Sheet1", 3, 3) + randomNum;
				String lastName = eUtils.getStringDataFromExcelSheet("Sheet1", 3, 4) + randomNum;
				String opportunityName = eUtils.getStringDataFromExcelSheet("Sheet1", 3, 5) + randomNum;
				String salesStage = eUtils.getStringDataFromExcelSheet("Sheet1", 3, 6);
				...
				Assert.assertTrue(titleHome.contains("Home"));
				...
				Assert.assertTrue(titleOpportunity.contains("Opportunities"));
			   ...
			   opportunities.clickOnplusImageOfOpporunity();
				...
				Assert.assertTrue(CrtNwOpp.contains("Creating New Opportunity"));
				...
				Assert.assertTrue(salesStageBox.getText().contains(salesStage));
